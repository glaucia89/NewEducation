                            ...
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="col-sm-10" style="padding-bottom: 25px;">
                                    <input name="year" type="number" class="form-control" id="yearschool"
                                           placeholder="ano" value="${}">
                                </div>
                                <label for="gradeshool" class="col-sm-2 control-label">Escola:</label>

                                <div class="col-sm-10" style="padding-bottom: 25px;">
                                    <input name="year" type="number" class="form-control" id="gradeshool"
                                           placeholder="classe" value="${}">
                                </div>
                            </div>
                    </div>
