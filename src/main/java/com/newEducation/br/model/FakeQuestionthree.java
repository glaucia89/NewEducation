 ...
 * <p/>
 * Questão com 3 alternativas do tipo imagem e texto
 */
public class FakeQuestionthree {
    ...
    public Answer getAnswerA() {
        ...
        if (responseA != null) {
            answer.setResponse(this.getResponseA());
        }
    ...
    public Answer getAnswerB() {
        ...
        if (responseB != null) {
            answer.setResponse(this.getResponseB());
        }
    ...
    public Answer getAnswerC() {
        ...
        if (responseC != null) {
            answer.setResponse(this.getResponseC());
        }
